...
class PageAlta {
    ...
    static validators = {
        ...
        'category': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,200}$/, //nuevo
        'stock': /^\d+$/,       //  /^[.\d]{1,99}$/,
        'brand': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,25}$/,
        //'image': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,500}$/,
        //'image': /([a-z\-_0-9\/\:\.]*\.(jpg|jpeg|png|gif))/i,
        'image': /([a-z\-_0-9\/\:\.]*\.(jpg|jpeg|png|gif|webp))/i,
        
        //'archivo': /\.(jpeg|png|gif|bmp|jpg)$/i,
    };
    ...
    static async addTableEvents() {
        ...
        const editProduct = async e => {
            ...
            const category = row.querySelector('.cell-categoria').innerHTML; // esto es nuevo
            const stock = row.querySelector('.cell-stock').innerHTML; // esto es nuevo
            const brand = row.querySelector('.cell-brand').innerHTML; // esto es nuevo
            ...
            productToEdit.category = category; // esto es nuevo
            productToEdit.stock = stock; // esto es nuevo
            productToEdit.brand = brand; // esto es nuevo
